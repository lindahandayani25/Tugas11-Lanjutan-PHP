...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2023 at 02:20 PM
...
(1, '00001', 'Produk B', 1500, 5, 'pcs', 1),
(2, '00002', 'Produk C', 2000, 3, 'pcs', 2),
(3, '00003', 'Produk D', 5500, 12, 'pcs', 3);
...
INSERT INTO `supplier` (`id_supplier`, `nama`, `telpon`, `alamat`) VALUES
...
--
ALTER TABLE `produk`
  ADD CONSTRAINT `produk_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`id_supplier`) ON DELETE CASCADE;
COMMIT;
